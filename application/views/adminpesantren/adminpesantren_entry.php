...
<div class="content-wrapper">
  ...
  <div class="content-inner">
    ...
    <div class="content">
      ...
      <div class="card">
        <div class="card-body">
          <form action="<?= site_url('admin_pesantrens/proses'); ?>" id="frmuser" method="post" enctype="multipart/form-data">
            <fieldset class="mb-3">
              ...
              <div class="form-group row">
                ...
                <div class="col-lg-10">
                  <input type="text" name="nama" id="nama" class="form-control" placeholder="Masukkan Nama Admin..." required value="<?= $nama ?>">
                </div>
              </div>
              <div class="form-group row">
