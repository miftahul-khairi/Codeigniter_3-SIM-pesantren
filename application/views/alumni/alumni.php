    ...
    <div class="content">
      ...
      <div class="card">
        ...
        <div class="card-header">
          <a href="<?= site_url('alumnis/entry/'); ?>" class="btn btn-success">Tambah Data</a>
        </div>
        <?php } ?>
                ...
                <div class="list-icons">
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                      <a href="<?= site_url('alumnis/entry/' . $val['id']); ?>" class="dropdown-item"><i class="icon-pencil"></i>Edit Data</a>
                      <a href="<?= site_url('alumnis/delete/' . $val['id']); ?>" class="dropdown-item" onclick="return confirm('Yakin ingin menghapus data ini...?')"><i class="icon-trash"></i>Delete</a>
                    </div>
                  </div>
                </div>
              </td>
