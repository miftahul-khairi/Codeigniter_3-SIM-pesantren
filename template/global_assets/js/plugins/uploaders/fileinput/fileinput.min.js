	...
	(t = {
		...
		isEmpty: function (i, a) {
			return (
				void 0 === i ||
				null === i ||
				(!t.isFunction(i) && (0 === i.length || (a && "" === e.trim(i))))
			);
		},
		isArray: function (e) {
			return (
			...
			stash: function (i) {
				...
				n.find("[style]").each(function (i, r) {
					...
					o &&
						...
						(a.domElementsStyles[l] = s),
						n.removeAttr("style").attr(a.CSP_ATTRIB, l));
				}),
		...
		whenAll: function (i) {
			...
			for (
				...
				(r = c[a]) && e.isFunction(r.promise)
					? r.promise().done(s(a, l, c)).fail(s(a, n, o))
		...
		(i.prototype = {
			...
			_init: function (i, a) {
				var r,
					...
					d = s.$element;
				(s.options = i),
					(s.canOrientImage = t.canOrientImage(d)),
					...
					void 0 === s.errorCloseButton &&
						(s.errorCloseButton = t.closeButton(
							"kv-error-close" + (t.isBs(5) ? "  float-end" : "")
						)),
					s.maxTotalFileCount > 0 &&
						s.maxTotalFileCount < s.maxFileCount &&
						(s.maxTotalFileCount = s.maxFileCount),
					s.rtl &&
						((l = s.previewZoomButtonIcons.prev),
						(s.previewZoomButtonIcons.prev = s.previewZoomButtonIcons.next),
						(s.previewZoomButtonIcons.next = l)),
					!isNaN(s.maxAjaxThreads) &&
						s.maxAjaxThreads < s.resumableUploadOptions.maxThreads &&
						(s.resumableUploadOptions.maxThreads = s.maxAjaxThreads),
					s._initFileManager(),
					"function" == typeof s.autoOrientImage &&
						(s.autoOrientImage = s.autoOrientImage()),
					"function" == typeof s.autoOrientImageInitial &&
						(s.autoOrientImageInitial = s.autoOrientImageInitial()),
					a || s._cleanup(),
					(s.duplicateErrors = []),
					...
					(s.progressInfoTemplate = o.replace("{class}", s.progressInfoClass)),
					(s.progressPauseTemplate = o.replace(
						"{class}",
						s.progressPauseClass
					)),
					...
					a
						? s._errorsExist() || s.$errorContainer.hide()
						: (s._resetErrors(),
						  s.$errorContainer.hide(),
						  (s.previewInitId = "thumb-" + d.attr("id")),
						  s._initPreviewCache(),
						  s._initPreview(!0),
									...
									"success" === t
										? ((o.uploadedSize += i.file.size),
										  a.showPreview &&
												...
												a._initUploadSuccess(i.chunksProcessed[s].data, d)),
										  o.removeFile(s),
										  delete i.chunksProcessed[s],
										...
										: "cancel" !== t &&
										  ...
										  a.$errorContainer.find(
												...
												(n = a.msgResumableUploadRetriesExceeded.setTokens(l)),
												e.extend(p, l),
								...
								e = setInterval(function () {
									...
									if (
										...
										"new" === n &&
											...
											o.initStats(l),
											o.stack[l] &&
												(i.init(l, o.stack[l], o.getIndex(l)),
												i.processUpload())),
										!o.isPending(l) && i.completed && (n = "new"),
										o.isProcessed())
									) {
										var s = a.$preview.find(".file-preview-initial");
										s.length && (t.addCss(s, t.SORT_CSS), a._initSortable()),
											clearInterval(e),
											a._clearFileInput(),
											a.unlock(),
											setTimeout(function () {
										...
										(b = function (r) {
											(w = a._getOutData(v, r)),
												a.showPreview &&
													...
													m.attr("disabled", !0)),
												a._raise("filechunkbeforesend", [u, e, l, o, i, w]);
										}),
										(_ = function (t, d, c) {
										...
										(C = function (t, r, n) {
											return a._isAborted()
												...
												: ((w = a._getOutData(v, t)),
												  ...
												  a._raise("filechunkajaxerror", [u, e, l, o, i, w]),
												  i.pushAjax(e, l + 1),
												  void h(g.resumableRetryError, { n: l - 1 }));
										}),
										(y = function () {
											a._isAborted() ||
			...
			_initTemplateDefaults: function () {
				...
				(i =
					...
					(l =
						'<div class="file-caption form-control {class}" {tabIndexConfig}>\n  <span class="file-caption-icon"></span>\n  <input readonly class="file-caption-name">\n</div>'),
					(s =
					...
					(N =
						'<div class="text-info file-upload-stats"><span class="pending-time">{pendingTime}</span> <span class="upload-speed">{uploadSpeed}</span></div>'),
					...
					(B = " {style}"),
					(E = W("html", "text/html")),
					(S = W("text", "text/plain;charset=UTF-8")),
				...
				(i.previewCache = {
					...
					get: function (e, a) {
						var r,
							...
							v = function (e, a, r, n, o, l, s, d) {
								var c =
										" file-preview-initial " + t.SORT_CSS + (s ? " " + s : ""),
									u = i.previewInitId + "-" + l,
									p = (f && f.fileId) || u;
						...
						return g && g.length
							? ((a = void 0 === a ? !0 : a),
							  ...
							  (s = t.ifSet("filename", f, t.ifSet("caption", f))),
							  (d = t.ifSet("filetype", f, o)),
							  (l = i.previewCache.footer(e, a, (f && f.size) || null)),
							  (c = t.ifSet("frameClass", f)),
							  (r = m
									? v(o, g, s, d, l, u, c)
									: v("generic", g, s, d, l, u, c, o).setTokens({
											content: p.content[e],
									  })),
					...
					footer: function (e, a, r) {
						...
						var o,
							...
							x = c === !1 && a;
						return (
							(_ = _ && l.downloadUrl !== !1 && !!h),
							(o = i._renderFileActions(l, !1, _, b, C, y, x, c, u, !0, h, v)),
				...
				return (
					(o =
						i.responseJSON && i.responseJSON.error
							...
							: ""),
					(l = o ? o : i.responseText),
					s.cancelling && s.msgUploadAborted && (d = s.msgUploadAborted),
					s.showAjaxErrorDetails &&
						...
						(o
							...
							: ((l = e.trim(l.replace(/\n\s*\n/g, "\n"))),
							  ...
							  (d += d ? n : l))),
					d || (d = s.msgAjaxError.replace("{operation}", t)),
					(s.cancelling = !1),
					r ? "<b>" + r + ": </b>" + d : d
				);
			},
			...
			_zoneDrop: function (e) {
				...
				if (
					...
					!a.isDisabled &&
						!t.isEmpty(o) &&
						a._raise("fileDragDrop", { sourceEvent: e, files: o }))
				)
					if (s > 0) {
					...
					t.getFrames(".file-preview-initial").each(function () {
						...
						s &&
							...
							a
								...
								: t.setImageOrientation(r, n, s.exif.Orientation, l)),
							i++;
					});
			},
			...
			_setZoomContent: function (i, a) {
				...
				(n = h.attr("data-template") || "generic"),
					(r = h.find(".kv-file-content")),
					(o = r.length ? r.html() : ""),
					(p = i.data("caption") || ""),
					(f = i.data("size") || ""),
					(l = p + " " + f),
					v
						...
						.html(l),
					(s = v.find(".kv-zoom-body")),
					v.removeClass("kv-single-content"),
					a
						? ((u = s.addClass("file-thumb-loading").clone().insertAfter(s)),
						  t.setHtml(s, o).hide(),
					...
					v.data("previewId", m),
					g._handler(v.find(".btn-kv-prev"), "click", function () {
						g._zoomSlideShow("prev", m);
					}),
					g._handler(v.find(".btn-kv-next"), "click", function () {
						...
						var e,
							...
							r = function (e) {
								var i = g.$modal.find(".kv-zoom-body"),
									a = g.zoomModalHeight;
								v.hasClass("file-zoom-fullscreen") &&
			...
			_zoomSlideShow: function (t, i) {
				...
				if (!s.attr("disabled")) {
					...
					0 > o ||
						...
						!c[o] ||
						((a = e(c[o])),
						a.length && l._setZoomContent(a, !0),
						l._initZoomButtons(),
						l._raise("filezoom" + t, { previewId: i, modal: l.$modal }));
				}
			},
			...
			_resetPreview: function () {
				...
				n.previewCache.count(!0)
					? ((i = n.previewCache.out()),
					  s &&
							...
							n.getFrames().each(function () {
								...
								((o && t.hasClass("file-preview-success")) ||
									(l && t.hasClass("file-preview-error"))) &&
									r.append(t);
							})),
					  ...
					  n._setCaption(a),
					  s && (r.contents().appendTo(n.$preview), r.remove()))
				...
				var a = this,
					...
					n = function (e) {
						...
						e.lengthComputable &&
							...
							(n = t.round((l / o) * 100)),
							i
								? a._setFileUploadStats(i, n, s)
								: a._setProgress(n, null, null, a._getStats(s)),
							a._raise("fileajaxprogress", [s]);
					};
				return (
					e.upload &&
			...
			_ajaxSubmit: function (t, i, a, r, n, o, l, s) {
				...
				f._raise("filepreajax", [n, o, l]) &&
					...
					(s = s || f.uploadUrlThumb || f.uploadUrl),
					"function" == typeof s && (s = s()),
					(u = f._getExtraData(o, l) || {}),
					"object" == typeof u &&
					...
					(p = f.taskManager.addTask(o + "-" + l, function () {
						var t,
							i,
							a = this.self;
					...
					: (void 0 !== i.initialPreview &&
							...
							void 0 !== a
								? r
									...
									: ((l = m.previewCache.add(c[0], u[0], p[0], n)),
									  (o = m.previewCache.get(l, !1)),
									  (s = t.createElement(o).hide().appendTo(a)),
			...
			_uploadSingle: function (i, a, r) {
				...
				w.enableResumableUpload ||
					(w.showPreview &&
						...
						(s = o.find(".kv-file-upload")),
						(d = o.find(".kv-file-remove")),
						u.show()),
					0 === _ ||
						!x ||
						(w.showPreview && s && s.hasClass("disabled")) ||
						w._abort(F) ||
						((v = function () {
							c ? b.errors.push(a) : b.removeFile(a),
								b.setProcessed(a),
								b.isProcessed() && ((w.fileBatchCompleted = !0), l());
						}),
						(l = function () {
							var e;
						...
						(p = function (l) {
							(n = w._getOutData(C, l)),
								...
								w._raise("filepreupload", [n, y, i, w._getThumbFileId(o)]),
								e.extend(!0, F, n),
								w._abort(F) &&
									(l.abort(),
									r ||
						...
						(g = function (l, d, p) {
							...
							(n = w._getOutData(C, p, l)),
								e.extend(!0, F, n),
								setTimeout(function () {
									t.isEmpty(l) || t.isEmpty(l.error)
										? (w.showPreview &&
												(w._setThumbStatus(o, "Success"),
												s.hide(),
												w._initUploadSuccess(l, o, r),
												w._setProgress(101, u)),
										  w._raise("fileuploaded", [n, g, i, w._getThumbFileId(o)]),
										  r ? v() : w.fileManager.remove(o))
										: ((c = !0),
										  (f = w._parseError(
												T,
												p,
					...
					(l = function () {
						...
						(a = function (i, a, r) {
							...
							t.isEmpty(i) || t.isEmpty(i.error)
								? (s._raise("filebatchuploadsuccess", [n]),
								  l(),
								  s.showPreview
										? (c.each(function () {
												var t = e(this);
												s._setThumbStatus(t, "Success"),
													t.removeClass("file-uploading"),
													t
														.find(".kv-file-upload")
														.hide()
								...
								: (s.showPreview &&
										(c.each(function () {
											...
											t.removeClass("file-uploading"),
												...
												0 === u.length || -1 !== e.inArray(d, u)
													? (s._setPreviewError(t, !0),
													  s.retryErrorUploads ||
															(t.find(".kv-file-upload").hide(),
															s.fileManager.remove(t)))
													: (t.find(".kv-file-upload").hide(),
													  s._setThumbStatus(t, "Success"),
													  s.fileManager.remove(t)),
										...
										s._initUploadSuccess(i)),
								  (o = s._parseError(g, r, s.msgUploadError)),
								  s._showFileError(o, n, "filebatchuploaderror"),
								  s._setProgress(101, s.$progress, s.msgUploadError));
						}),
						(n = function () {
							s.unlock(),
								s._initSuccessThumbs(),
								s._clearFileInput(),
						...
						(r = function (t, i, a) {
							...
							(o = s._parseError(g, t, a)),
								s._showFileError(o, r, "filebatchuploaderror"),
								(s.uploadFileCount = c - 1),
								s.showPreview &&
									(s._getThumbs().each(function () {
										var t = e(this);
										t.removeClass("file-uploading"),
											s._getThumbFile(t) && s._setPreviewError(t);
									}),
									s._getThumbs().removeClass("file-uploading"),
									s._getThumbs(" .kv-file-upload").removeAttr("disabled"),
									s._getThumbs(" .kv-file-delete").removeAttr("disabled"),
									s._setProgress(
										101,
										s.$progress,
										s.msgAjaxProgressError.replace("{operation}", g)
									));
						});
					var m = 0;
					e.each(s.fileManager.stack, function (e, i) {
						t.isEmpty(i.file) ||
							s._setFileData(f, i.file, i.nameFmt || "untitled_" + m, e),
							m++;
					}),
				...
				o._abort(l) ||
					((e = function (e) {
						...
						o._raise("filebatchpreupload", [t]),
							...
							(l.data = t),
							(l.xhr = e),
							o._abort(l) && (e.abort(), o._setProgressCancelled());
					}),
					(i = function (e, i, a) {
				...
				i._initZoomButton(),
					a.find(n).each(function () {
						...
						if (!t.isEmpty(p) && void 0 !== f) {
							...
							(y = parseInt(y.replace(t.INIT_FLAG, ""))),
								(v =
									t.isEmpty(C.config) && t.isEmpty(C.config[y])
										? null
										: C.config[y]),
								(b = t.isEmpty(v) || t.isEmpty(v.extra) ? r : v.extra),
								(w = (v && (v.filename || v.caption)) || ""),
								"function" == typeof b && (b = b()),
								(h = { id: u.attr("id"), key: f, extra: b }),
								(n = function (e) {
									(i.ajaxAborted = !1),
								...
								(o = function (e, r, n) {
									...
									return t.isEmpty(e) || t.isEmpty(e.error)
										...
										: ((h.jqXHR = n),
										  ...
										  u.removeClass("disabled " + l).addClass(s),
										  void d());
								}),
								(c = function (e, t, a) {
			...
			_generatePreviewTemplate: function (
				...
				return (
					(v =
						400 > x
							? b.previewSettingsSmall[S] || b.defaults.previewSettingsSmall[S]
							: b.previewSettings[S] || b.defaults.previewSettings[S]),
					v &&
					...
					(w = function (a, s, d, u) {
						var m = d ? "zoom-" + o : o,
							...
							v = (c || "") + " " + u;
						return (
							b.frameClass && (v = b.frameClass + " " + v),
							d && (v = v.replace(" " + t.SORT_CSS, "")),
							(h = b._parseFilePreviewIcon(h, r)),
							"object" !== i ||
								n ||
			...
			_previewDefault: function (e, i) {
				...
				if (a.showPreview) {
					...
					a._clearDefaultPreview(),
						(n = a._generatePreviewTemplate("other", u, o, l, f, p, c, s)),
						a._addToPreview(r, n),
						a._setThumbAttr(f, d, s),
						i === !0 &&
							a.isAjaxUpload &&
			...
			_previewFile: function (e, i, a, r, n) {
				if (this.showPreview) {
					var o,
						...
						h = l._getThumbId(m);
					(o = l._generatePreviewTemplate(u, g, s, d, h, m, !1, f)),
						l._clearDefaultPreview(),
						l._addToPreview(p, o);
					var v = l._getFrame(h);
					l._validateImageOrientation(v.find("img"), i, h, m, c, d, f, g),
						l._setThumbAttr(h, c, f),
						l._initSortable();
				}
			},
			...
			_setInitThumbAttr: function () {
				...
				if (0 !== l)
					for (var s = 0; l > s; s++)
						(e = o.config[s]),
							(r = n.previewInitId + "-" + t.INIT_FLAG + s),
			...
			_updateFileDetails: function (e, i) {
				...
				!c && s.fileManager.count() > 0
					? ((l = s.fileManager.getFirstFile()), (a = l.nameFmt))
					: (a = c ? s.slug(c) : "_"),
					(r = s.isAjaxUpload ? s.fileManager.count() : e),
					(o = s.previewCache.count(!0) + r),
					(n = 1 === r ? a : s._getMsgSelected(o)),
					s.isError
						? (s.$previewContainer.removeClass("file-thumb-loading"),
						  s.$previewStatus.html(""),
						  s.$captionContainer.removeClass("icon-visible"))
						: s._showFileIcon(),
					s._setCaption(n, s.isError),
					s.$container.removeClass("file-input-new file-input-ajax-new"),
					i || s._raise("fileselect", [e, a]),
				...
				if (((i = i || n.$progress), i.length)) {
					...
					e >= 100 && (r = ""),
						t.isEmpty(c) ||
							((o =
								s && l > s && 100 >= e
									? c.setTokens({ percent: s, status: n.msgUploadThreshold })
									: c.setTokens({
											percent: l,
				...
				if (n.showPreview || (o && o.length)) {
					...
					if (n.enableResumableUpload) {
						...
						(m += h),
							...
							(l = Math.floor((100 * g) / p)),
							(f.pendingBytes = p - g),
							n._setResumableProgress(l, f);
					} else
						s.setProgress(i, a),
							(o = c && c.length ? c.find(".file-thumb-progress") : null),
							n._setProgress(a, o, null, n._getStats(r)),
							e.each(s.stats, function (e, t) {
								u += t.loaded;
							}),
							(f.pendingBytes = p - u),
							(l = t.round((u / p) * 100)),
							n._setProgress(l, null, null, n._getStats(f));
				}
			},
			...
			_checkDimensions: function (e, i, a, r, n, o, l) {
				...
				!t.isEmpty(g) &&
					...
					(u = "Small" === i ? d >= g : g >= d),
					u ||
						((s = p["msgImage" + o + i].setTokens({ name: n, size: g })),
						p._showFileError(s, l),
			...
			setImageOrientation: function (i, a, r, n) {
				...
				(c && u) ||
					((s = "load.fileinputimageorient"),
					f
						? ((i = a),
						  (a = null),
						  i.css(d.previewSettings.image),
						  (l = e(document.createElement("div")).appendTo(
					...
					i.off(s).on(s, function () {
						...
						if (
							...
							s && a.data("orientation", r),
							5 > r)
						)
							return t.setTransform(e, g), void t.setTransform(s, g);
						var m = Math.atan(u / c),
							h = Math.sqrt(Math.pow(c, 2) + Math.pow(u, 2)),
							v = h ? c / Math.cos(Math.PI / 2 + m) / h : 1,
							w = " scale(" + Math.abs(v) + ")";
						t.setTransform(e, g + w),
							t.setTransform(s, g + w),
							f &&
								(i
			...
			_validateImageOrientation: function (i, a, r, n, o, l, s, d) {
				...
				return p.canOrientImage
					? (i.css("image-orientation", g ? "from-image" : "none"),
					  void p._validateImage(r, n, o, l, s, d, f))
					...
					m
						.one("load", function () {
							(d = f.width()),
								(c = p.width()),
								d > c && m.css("width", "100%"),
								(s = { ind: g, id: t, fileId: i }),
								u._checkDimensions(g, "Small", m, f, a, "Width", s),
								u._checkDimensions(g, "Small", m, f, a, "Height", s),
								u.resizeImage ||
									(u._checkDimensions(g, "Large", m, f, a, "Width", s),
									u._checkDimensions(g, "Large", m, f, a, "Height", s)),
								u._raise("fileimageloaded", [t]),
								u.fileManager.addImage(i, {
									ind: g,
									img: m,
									thumb: f,
									pid: t,
			...
			_getResizedImage: function (i, a, r, n) {
				...
				if (
					...
					(f = h.fileManager.getFile(i)),
					(g = { id: k, index: E, fileId: i }),
					(m = [i, k, E]),
					(!f || !x || (C >= w && y >= b)) &&
						(x && f && h._raise("fileimageresized", m),
						r.val++,
						r.val === n && h._raise("fileimagesresized"),
						!x))
				)
					return void c(h.msgImageResizeError, g, "fileimageresizeerror");
				(F = F || h.resizeDefaultImageType),
					(l = w > C),
					(s = b > y),
					(_ =
				...
				try {
					P.drawImage(v, 0, 0, w, b),
						(d = T.toDataURL(F, h.resizeQuality)),
						S &&
							((p = window.piexif.dump(S)), (d = window.piexif.insert(p, d))),
						(o = t.dataURI2Blob(d)),
				...
				if (c.$caption.length) {
					if ((c.$captionContainer.removeClass("icon-visible"), a))
						(r = e("<div>" + c.msgValidationError + "</div>").text()),
							(l = c.fileManager.count()),
							l
								? ((d = c.fileManager.getFirstFile()),
								  (s = 1 === l && d ? d.nameFmt : c._getMsgSelected(l)))
								: (s = c._getMsgSelected(c.msgNo)),
							(n = t.isEmpty(i) ? s : i),
							(o =
								'<span class="' +
			...
			_renderFileFooter: function (e, i, a, r, n) {
				...
				return (
					...
					s.isAjaxUpload
						? ((l.progress = s._renderThumbProgress()),
						  (l.actions = s._renderFileActions(l, p, !1, c, f, u, !1, !1, !1)))
						: (l.actions = s._renderFileActions(
								l,
								!1,
								!1,
								!1,
					...
					(o = g.setTokens(l)),
					(o = t.replaceTags(o, s.previewThumbTags))
				);
			},
			_renderFileActions: function (e, t, i, a, r, n, o, l, s, d, c, u) {
				...
				return (
					a &&
						(w = p._getLayoutTemplate("actionDelete").setTokens({
							removeClass: T,
					...
					t &&
						(b = p._getLayoutTemplate("actionUpload").setTokens({
							uploadClass: y.uploadClass,
							uploadIcon: y.uploadIcon,
							uploadTitle: y.uploadTitle,
						})),
					i &&
						((_ = p._getLayoutTemplate("actionDownload").setTokens({
						...
						(_ = _.setTokens({ filename: u, key: s }))),
					r &&
						(m = p._getLayoutTemplate("actionZoom").setTokens({
					...
					n &&
						d &&
						((f = "drag-handle-init " + y.dragClass),
						(h = p._getLayoutTemplate("actionDrag").setTokens({
							dragClass: f,
			...
			_change: function (i) {
				...
				if (!a.changeTriggered) {
					var r,
						...
						w = function (t, i, r, n) {
							...
							return (
								...
								c ? a._showFileError(t, o) : a._showError(t, l)
							);
						},
						b = function (e, t, i) {
					...
					if (
						(a._resetErrors(),
						(l = r.length),
						(o = c ? a.fileManager.count() + l : l),
						(n = a._getFileCount(o, h ? !1 : void 0)),
						g > 0 && n > g)
					) {
						if (!a.autoReplace || l > g)
							return void b(a.autoReplace && l > g ? l : n, g);
						n > g && a._resetPreviewThumbs(c);
					} else {
						if (h && ((n = a._getFileCount(o, !0)), m > 0 && n > m)) {
							if (!a.autoReplace || l > g)
								return void b(a.autoReplace && l > m ? l : n, m, !0);
							n > g && a._resetPreviewThumbs(c);
						}
						!c || v
			...
			_canPreview: function (e) {
				...
				return (
					(a = !u || -1 !== u.indexOf(c)),
					(r = !p || -1 !== p.indexOf(s)),
					(n = !f.length || t.compare(l, w)),
					(o =
						(g && -1 !== g.indexOf(c)) ||
						(m && -1 !== m.indexOf(s)) ||
						(h.length && t.compare(l, b)) ||
						(v && !isNaN(v) && d > v)),
					!o && (a || r || n)
				);
			},
					...
					(a = function (w) {
						...
						var y,
							...
							V = function () {
								...
								setTimeout(function () {
									l.html(t), r._updateFileDetails(u), a(w + 1);
								}, r.processDelay),
									r._raise("fileloaded", [j, M, U, w, n]) && r.isAjaxUpload
										? e || C.add(j)
										: e && C.removeFile(U);
							};
						if (j) {
							...
							if (0 === R.length)
								return (
									(T = r.msgInvalidFileName.replace(
										"{name}",
										t.htmlEncode(t.getFileName(j), "[unknown]")
									)),
									void v(T, j, M, w, I)
								);
							if (
								(t.isEmpty(m) ||
									(O = new RegExp("\\.(" + m.join("|") + ")$", "i")),
								(y = B.toFixed(2)),
								(r.isAjaxUpload && C.exists(I)) || r._getFrame(M, !0).length)
							) {
								var q = { id: M, index: w, fileId: I, file: j, files: i };
								return (
									(T = r.msgDuplicateFile.setTokens({ name: R, size: y })),
									void (r.isAjaxUpload
										? (r.duplicateErrors.push(T),
										  (r.isDuplicateError = !0),
										  r._raise("fileduplicateerror", [j, I, R, y, M, w]),
										  a(w + 1),
										  r._updateFileDetails(u))
										: (r._showError(T, q),
										  r.unlock(),
							...
							if (r.maxFileSize > 0 && B > r.maxFileSize)
								return (
							...
							if (null !== r.minFileSize && B <= t.getNum(r.minFileSize))
								return (
							...
							if (!t.isEmpty(f) && t.isArray(f)) {
								for (x = 0; x < f.length; x += 1)
									(P = f[x]),
										(A = p[P]),
										(N +=
											A && "function" == typeof A && A(j.type, t.getFileName(j))
												? 1
												: 0);
								if (0 === N)
									return (
							...
							if (!r._canPreview(j))
								return (
									(S = r.isAjaxUpload && r._raise("filebeforeload", [j, w, n])),
									r.isAjaxUpload && S && C.add(j),
									r.showPreview &&
										S &&
									...
									void setTimeout(function () {
										S && r._updateFileDetails(u),
											a(w + 1),
											r._raise("fileloaded", [j, M, U, w]);
									}, 10)
								);
							(D = $(j.type, R)),
								l.html(s.replace("{index}", w + 1).replace("{files}", u)),
								o.addClass("file-thumb-loading"),
								...
								(n.onload = function (i) {
									...
									if (
										...
										for (
											d = new Uint8Array(i.target.result), x = 0;
											x < d.length;
											x++
										)
					...
					i.showPreview &&
						i._getThumbs().each(function () {
							...
							a.removeClass("file-uploading"),
								n.attr("title") === l.indicatorLoadingTitle &&
